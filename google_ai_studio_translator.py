...
# Усиливай реакции персонажей в рамках их характера (Если персонаж НПС - он не должен использовать маты).
...
# Яркий, матерный язык: Как основной инструмент стиля (но не перебарщивай).
